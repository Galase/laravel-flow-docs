...
PHP);
    ...
    public function test_command_generates_model_database_modular_and_injection_docs(): void
    {
        ...
        $this->assertStringContainsString('turma_id', $database);
        $this->assertStringContainsString('Indice', $database);
        $this->assertStringContainsString('Abrir diagrama', $database);
        ...
        $this->assertStringContainsString('turma_id -&gt; id', $diagram);
